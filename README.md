...
## 👉 Table Creation: PostgreSQL will always generate the eid automatically. You cannot manually insert a value for this ID.
```sql
...
```
## 👉PostgreSQL automatically generates the ID, but you can also provide your own ID manually if needed.
```sql
CREATE TABLE contact (
